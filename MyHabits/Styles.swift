...
class Styles {
    ...
    static let darkGrakColor: UIColor = .systemGray
    static let mediumGrayColor: UIColor = .systemGray2
    static let leghtGrayColor: UIColor = UIColor(red: 242.0/255.0, green: 242.0/255.0, blue: 247.0/255.0, alpha: 1.0)
...
extension UILabel {
    ...
    func applyFootnoteStyle() {
        ...
        self.textColor = Styles.darkGrakColor
    }
